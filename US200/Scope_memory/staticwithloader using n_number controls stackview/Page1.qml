...
Item {
    ...
    Item{
        anchors{top: parent.top; topMargin: 35}
        Text{id:p1;text:"Page1"; font.bold: true; anchors{fill: parent; leftMargin: 230}}
        ColumnLayout{
            id:cols
            anchors.fill:parent
            ...
            RowLayout {
                ...
                Rectangle{
                    ...
                    MouseArea{
                        ...
                        onClicked:{
                            navModel.reset("next");
                            stack.push("qrc:/Page2.qml",StackView.Immediate)
                        }
                    }
                }
            }
