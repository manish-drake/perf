...
#include "../../Scope_memory/withsqliteloader/us200-withsqliteloader/navigationmodel.h"
...
QT_MOC_LITERAL(1, 16, 8), // "nextPath"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 8), // "currPage"
QT_MOC_LITERAL(4, 35, 8), // "prevPath"
QT_MOC_LITERAL(5, 44, 12) // "scopeDispose"

    },
    "NavigationModel\0nextPath\0\0currPage\0"
    "prevPath\0scopeDispose"
};
...
void NavigationModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: { QString _r = _t->nextPath((*reinterpret_cast< const QString(*)>(_a[1])));
            if (_a[0]) *reinterpret_cast< QString*>(_a[0]) = std::move(_r); }  break;
        case 1: { QString _r = _t->prevPath((*reinterpret_cast< const QString(*)>(_a[1])));
            if (_a[0]) *reinterpret_cast< QString*>(_a[0]) = std::move(_r); }  break;
