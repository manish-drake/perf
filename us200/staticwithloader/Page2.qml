...
Item{
    anchors.fill: parent
    Text{text:"Page2"; font.bold: true; anchors.fill: parent; horizontalAlignment: Text.AlignHCenter}
    GridLayout {
        id: grid
        anchors.fill: parent
        ...
        Rectangle{
            ...
            MouseArea{
                anchors.fill:parent
                onClicked: loader.setSource("Page1.qml")
            }
        }
        Rectangle{
            id:frame5
            ...
            MouseArea{
                anchors.fill:parent
                onClicked:loader.setSource("Page3.qml")
            }
        }
    }
}
