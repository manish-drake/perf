...
Item{
    ...
    Text{id:p2;text:"Page2"; font.bold: true; anchors.fill: parent; horizontalAlignment: Text.AlignHCenter}
    GridLayout {
        id: grid
        anchors.fill: parent
        ...
        Rectangle{
            ...
            MouseArea{
                ...
                onClicked: {
                    currPath = "Page2"
                    loader.setSource(navigationModel.prevPath(currPath))
                }
            }
        }
        Rectangle{
            ...
            MouseArea{
                ...
                onClicked:{
                    currPath = "Page2"
                    loader.setSource(navigationModel.nextPath(currPath))
                }
            }
        }
    }
